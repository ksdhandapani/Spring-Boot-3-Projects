package com.dhandapani.spring_boot_mysql_testcontainers.exception;
...
@ControllerAdvice
public class SpringBootMysqlTestcontainersApplicationGlobalExceptionHandler extends ResponseEntityExceptionHandler {
